...
The deep dream feature sends observation summaries to Claude via your existing `claude --print` CLI. This uses your own Claude Code authentication and is subject to Anthropic's privacy policy, not ours. Deep dream runs automatically at session end by default. Disable with `snarc config deep_dream 0`.
